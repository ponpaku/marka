const dictionaries = {
  en: {
    ...
    "sidebar.noWorkspace": "Open a folder to view files",
    "sidebar.loading": "Loading...",
    "sidebar.noMdFiles": "No .md files found",
    ...
    "status.duplicated": "Duplicated: {0}",
    "status.moved": "Moved: {0}",
    "status.fsError": "Operation failed: {0}",
    // context menu
    "ctx.rename": "Rename",
    "ctx.delete": "Delete",
  ...
  ja: {
    ...
    "sidebar.closeFolder": "フォルダを閉じる",
    "sidebar.recentFiles": "最近開いたファイル",
    "sidebar.noRecent": "（なし）",
    "sidebar.noWorkspace": "フォルダを開くとファイルが表示されます",
    "sidebar.loading": "読み込み中...",
    "sidebar.noMdFiles": ".md ファイルがありません",
    "toc.empty": "見出しがありません",
    "status.exported": "書き出しました: {0}",
    "status.exportFailed": "書き出しに失敗しました",
    "status.renamed": "名前を変更しました: {0}",
    "status.deleted": "削除しました: {0}",
    "status.duplicated": "複製しました: {0}",
    "status.moved": "移動しました: {0}",
    "status.fsError": "操作に失敗しました: {0}",
    // context menu
    "ctx.rename": "名前を変更",
    "ctx.delete": "削除",
    "ctx.duplicate": "複製",
